package io.github.duckasteroid.cthugha.gl;
...
public class JCthughaGL implements GLEventListener {
  ...
  public void init(GLAutoDrawable drawable) {
    ...
    System.out.println("Screen="+window.getWidth() + "x" + window.getHeight());
    ...
    try(InputStream dogJpeg = JCthughaGL.class.getResourceAsStream("/shaders/gl4/molly.jpg")) {
