 ...
 */
public class WaveInterference extends AbstractNode implements TranslateTableSource {
  ...
  public XYParam source3 = new XYParam("Source 3", 0, 1, 0.5);
