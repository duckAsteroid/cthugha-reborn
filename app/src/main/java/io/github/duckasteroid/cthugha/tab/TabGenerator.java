 ...
 */
public interface TabGenerator extends Node {

  /**
   * Capture current parameter state, perform any randomised setup, and return a
   * {@link TabMapping} that maps each destination pixel to its source pixel.
   ...
   */
  TabMapping generate(int width, int height, Random rng);
